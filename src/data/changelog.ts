...
export const changelog: ChangelogRelease[] = [
  ...
  },
  {
    ...
    title: '底栏按压动画放缓',
    changes: [
      '减慢底栏按压时选中框的平移、放大与半透明变化，让动作连贯自然。',
      '松手后的尺寸、位置和透明度恢复也采用相同的平滑节奏。'
    ]
  },
  {
    version: '1.2.5',
    ...
    title: '底栏同步放大反馈',
    changes: [
      '按住底栏时，底栏与选中框同步放大，选中框扩展到栏边缘之外。',
      '选中框移除光效并提高透明度，按住时仍能透出底栏边缘。'
    ]
  },
  {
    version: '1.2.4',
    ...
    title: '底栏纯色按压反馈',
    changes: [
      '选中框恢复纯色朱红，取消按压高光；按住时放大 25% 并保持半透明。',
      '松手后选中框恢复不透明和原有大小，底栏同步恢复位置与尺寸。'
    ]
  },
  {
    version: '1.2.3',
  ...
  },
  {
    ...
    title: '底栏玻璃质感与按压反馈',
    changes: [
      '底栏选中框增加轻微模糊、透光和边缘高光，呈现柔和玻璃质感。',
      '按住时选中框放大更明显并亮起，松手或取消拖动后平滑恢复原有大小和亮度。'
    ]
  },
  {
    version: '1.2.0',
    ...
    title: '拖动导航与学习状态修复',
    changes: [
      '底部导航支持按住放大、拖动选中框并松手切换页面，图标颜色随位置实时过渡，长按不再选中文字。',
      '云同步保留当前学习和对比内容，避免静置后出现内容为空的提示。',
      '优化记录词语展开与收回的连续缩放，修复搜索框和收藏按钮的高光、边框及形状。',
      '限制页面双击放大，修复移动端点击搜索框时自动放大的问题，保留双指缩放。'
    ]
  },
  {
    version: '1.1.2',
  ...
  },
  {
    ...
    title: '恢复学习卡片展开动效',
    changes: [
      '恢复学习与对比页面圆球展开、收回卡片时的原有节奏、中心轨迹和玻璃质感。'
    ]
  },
  {
    version: '1.1.0',
    ...
    title: '阅读界面与交互动效优化',
    changes: [
      '提高辅助文字可读性，统一主要页面标题、设置说明和主题材质层次。',
      '复习卡新增明确的翻面操作，长释义可滚动阅读；复习页从记录进入后会返回记录。',
      '日报删除增加确认步骤，记录列表的查看与删除操作更清晰。',
      '记录详情可在展开过程中立即原路收回，云同步选择界面更加紧凑。'
    ]
  },
  {
    version: '1.0.0',
    ...
    title: '学习统计与视觉一致性优化',
    changes: [
      '新增学习统计，集中查看已学词语、已掌握词语、连续学习天数与复习正确率。',
      '新增学习成果趋势，展示近 7 日每日活动和近 30 日活动总量；旧记录也可纳入统计。',
      '统一页面标题、卡片、状态提示与按钮细节，优化窄屏日报、深色云同步弹窗和个人页布局。',
      '学习统计随本地备份与云同步保存，恢复后继续显示已有学习成果。'
    ]
  },
  {
    version: '0.9.8',
    ...
    title: '云同步备份与恢复增强',
    changes: [
      '云同步会记录最近一次成功时间、同步类型和成功或失败结果；失败提示会隐藏地址、令牌和凭据信息。',
      '版本与数据新增安全本地备份，可查看备份摘要并保留最近 3 个备份点，备份文件不包含 API Key、同步口令或登录凭据。',
      '恢复前会先完整校验并展示学习、复习和日报摘要，需要两次确认；恢复中途失败会回滚到恢复前数据。',
      '学习记录、收藏、统计、完整复习进度与掌握度、Daily/PDF/链接文章状态和非敏感偏好均可备份恢复，并继续兼容旧版备份。'
    ]
  },
  {
    version: '0.9.7',
    ...
    title: '日报查词接入复习',
    changes: [
      '日报中划词或点击重点词进行查词后，会复用学习页同一份词卡并自动进入长期复习体系。',
      '重复查询不会产生重复复习项，已掌握词再次学习时会保留原有掌握状态和历史进度。',
      'PDF 文章与链接文章使用相同的随文查词流程；删除日报不会删除已经形成的学习卡或复习进度。',
      '补强日报、复习与云同步的联动回归测试，同时保持星标、已学完、历史分组、PDF 导入和查词弹层行为不变。'
    ]
  },
  {
    version: '0.9.6',
    ...
    title: '查词自动加入复习',
    changes: [
      '成功学习一个新词后会自动加入长期复习，不再需要手动建立复习记录。',
      '重复查询、缓存恢复和重新生成都会保留已有复习进度，已掌握词不会因为再次学习而丢失历史状态。',
      'API 失败、取消或返回不完整内容时不会误加入复习；删除搜索历史也不会删除长期复习进度。',
      '收藏与复习状态继续独立保存，并补充学习到复习的数据连接与云同步回归测试。'
    ]
  },
  {
    version: '0.9.5',
    ...
    title: '每日复习流程完善',
    changes: [
      '复习页新增今日待复习、今日目标和完成进度，刷新页面后仍会保留当前复习进度。',
      '普通复习只安排已经到期的词语，已掌握词不会重复进入队列，答错词会按规则稍后再次出现。',
      '复习操作补齐答对、答错、稍后复习和已掌握，仍保留连续答对、撤回、划卡和查看释义。',
      '完成目标后会明确显示今日完成状态，没有到期内容时显示空状态，并继续适配减少动态效果。'
    ]
  },
  {
    version: '0.9.4',
    ...
    title: '复习进度与间隔调度升级',
    changes: [
      '为每个学习词语建立独立复习状态，会记录下次复习时间、复习间隔以及累计正确和错误次数。',
      '复习完成后会根据掌握情况逐步延长间隔；本轮出现答错时会回到学习阶段，之后更快再次复习。',
      '保留原有连续答对机制和撤回操作，撤回时长期复习进度也会同步恢复。',
      '旧版复习记录会自动兼容迁移，云同步可以继续合并新旧设备的复习数据。'
    ]
  },
  {
    version: '0.9.3',
  ...
  },
  {
    ...
    title: '云同步与模型设置精简',
    changes: [
      '云同步改为默认安全合并，只需选择开启同步或仅在本机，并将手动操作收敛为立即同步。',
      '名称与头像作为同一份个人资料同步；头像会在上传前压缩，旧版学习数据可继续读取。',
      '深度思考开关和强度选择统一跟随主题色，模型与 API 页面移除重复选项并默认收起高级设置。',
      '修复新增模型服务商弹层缺少进入动画的问题，展开和收起现在沿同一路径衔接。'
    ]
  },
  {
    version: '0.7.2',
  ...
  },
  {
    ...
    title: '修复对比按钮触控',
    changes: [
      '修复圆球下方提示文字的留白遮挡按钮的问题，对比模式现在可以正常点击添加词语和发送对比，同时保留收藏入口交互。'
    ]
  },
  {
    version: '0.6.7',
  ...
  },
  {
    ...
    title: '稳定手机圆球展开与更新检查',
    changes: [
      '发送词语时等待手机键盘收起、视口稳定后再展开，圆球以中心锚点展开，收起时避免滚动与动画互相干扰。',
      '打开应用、回到前台及持续使用时主动检查更新，移除无更新时的额外等待，已下载的新版本直接提示。',
      '区分检查更新与下载新版本状态，下载尚未完成时不再误报为最新版。'
    ]
  },
  {
    version: '0.6.4',
  ...
  },
  {
    ...
    title: '学习与对比融合为圆球工作台',
    changes: [
      '学习和对比合并为一个页面，点击中央圆球旋转切换；对比模式向左下、右下分裂出添加与发送按钮。',
      '输入栏随模式切换为两个胶囊，第三个词语向下分裂、第四个向右分裂，删除按钮平滑显隐。',
      '发送后圆球展开为保留原有内容布局的卡片，点击右上角关闭按钮收回圆球，方便继续切换模式。',
      '保留旧对比链接、复习跳转和学习记录，输入草稿在模式切换时保留。'
    ]
  },
  {
    version: '0.5.7',
  ...
  },
  {
    ...
    changes: [
      ...
      '模型与 API 设置新增独立的 MiMo 语音配置，支持保存密钥、选择音色、调整语速和试听。',
      '模型配置页针对平板改为双栏紧凑布局，并改善第三方输入法与静音模式下的播放兼容性。',
      '三套 API 配置保存后默认进入只读展示状态，点击编辑后才能修改；API Key 使用适中圆点隐藏并可随时显示。',
      '黛蓝、竹青和紫藤主题补齐协调的背景、卡片与文字色板，设置页图标也会跟随当前主题色。',
      '学习记录展开后的词语卡采用学习页排版，拼音固定在词语上方，并保留词语放大与卡片收放动画。'
    ]
  },
  {
    version: '0.4.0',
