...
.api-key-field input.concealed { -webkit-text-security: disc; }
...
@media (min-width: 768px) { .api-key-field input { margin-top: 4px; padding-block: 9px; } .api-key-toggle { bottom: 2px; } }
</style>
