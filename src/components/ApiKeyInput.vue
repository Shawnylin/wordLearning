...
.api-key-field.is-concealed::after { content: '••••••••••••'; position: absolute; left: 13px; bottom: 11px; z-index: 1; color: var(--ink-mute); font-size: 11.5px; line-height: 1; letter-spacing: 2px; opacity: .82; pointer-events: none; }
...
@media (min-width: 768px) { .api-key-field input { margin-top: 4px; padding-block: 9px; font-size: 15px; } .api-key-toggle { bottom: 2px; } .api-key-field.is-concealed::after { bottom: 8px; } }
</style>
