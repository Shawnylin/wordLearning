...
.profile-insights-grid span, .profile-insights-heading span, .profile-insights-empty { color: var(--ink-mute); font-size: 12px; line-height: 1.5; }
...
.profile-trend-count, .profile-trend-date { color: var(--ink-mute); font-size: 11px; line-height: 1.3; font-variant-numeric: tabular-nums; white-space: nowrap; }
