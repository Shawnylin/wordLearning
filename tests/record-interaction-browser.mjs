...
assert(Math.abs((await page.locator('#bottom-nav-indicator').evaluate(e=>new DOMMatrix(getComputedStyle(e).transform).a))-1.18)<.001)
...
assert(moving.left>initialLeft+10 && moving.scale>1 && moving.scale<1.18,'translation and enlargement should start on pointerdown')
